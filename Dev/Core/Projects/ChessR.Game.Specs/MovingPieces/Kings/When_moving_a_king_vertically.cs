...
namespace ChessR.Game.Specs.MovingPieces.Kings
{
    ...
    public class When_moving_a_king_vertically : GameSubject
    {
        static King king;
        ...
        Because of = () => king.MoveTo(new Location("G8"));

        It should_move_the_king_vertically = () =>
            game.GetPiece("G8").ShouldBeEquivalentTo(king);
    }
}
